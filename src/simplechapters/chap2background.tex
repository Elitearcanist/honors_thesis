...
to equation \ref{eq:chirp_range} to calculate distance.
The $f_D$ in figure \ref{fig:fmcw} is the doppler shift.
Doppler shift can be used to determine the velocity of the target.
Doppler shift will not be used in this paper to determine target velocity.
...
Software defined radios (SDRs) are a commercial product that has grown immensely in the last few decades.
SDRs rely on advanced and configurable RF front ends and FPGAs for collecting and processing RF samples in real time.
