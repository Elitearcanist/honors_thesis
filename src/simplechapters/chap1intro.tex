...
This introductory review will focus on more recent publications in SDR Radar research
...
They did not use a commercial SDR, but the Radio Frequency (RF) frontend used the AD9361 which is software defined.
...
Monk's paper focused on different software and hardware options for running an SDR-based Radar Front-End.
