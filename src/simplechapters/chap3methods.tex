...
This allowed the SDR to be run at a higher sample rates with less errors.
We also noticed that the host computer also played a big factor in sample errors, using a computer such as a Raspberry Pi 4 would significantly increase sample errors while laptops or desktops would reduce that effect.
% TODO cite ORCA paper as they analyzed this
...
Additionally below are radargrams showing the 
