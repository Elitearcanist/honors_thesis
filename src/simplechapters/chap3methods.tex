...
This SDR only has one transmit channel and a sample rates of 30.72 Mega Samples per Second (MSPS) with a frequency range of 10 MHz - 3.5 GHz.
For this SDR the software suite SoapySDR was used, which abstracts SDR commands for a
variety of different SDR products and models into one driver interface \cite{noauthor_home_nodate}.
The SDR was connected to two 2.4 GHz horn antennas and a computer to issue commands and collect samples.
Using SoapySDR samples were collected at 2.4 GHz on the LimeSDR-Mini to test its ability as a radar.
...
A more powerful and expensive SDR was used:
...
Changes were added to allow multichannel data collection and configurations for using the B210 SDR.
...
\begin{figure}
    ...
    \caption{The test cart with the mounted electronics, including
