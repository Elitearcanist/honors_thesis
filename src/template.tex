\documentclass[simple,masters]{byuthesis}
...
\title{Software-defined Radios in Avalanche Detection}
...
\committeechair{David G. Long}
\committeemember{Karl F. Warnick}
\committeemember{Ryan Camacho}

% Include any keywords you would like for your thesis/dissertation
% (all lowercase except proper nouns)
\keywords{remote sensing, software-defined radio, radar, FMCW radar, snow, avalanche}
...
% \customtitlepage % Honors Thesis doesnt want custom titlepage :(
% \clearpage
...
% Simple Version
\include{simplechapters/chap1intro}
\include{simplechapters/chap2background}
\include{simplechapters/chap3methods}
\include{simplechapters/chap4results}
\include{simplechapters/chap5nextSteps}
\include{simplechapters/chap6conclusions}
